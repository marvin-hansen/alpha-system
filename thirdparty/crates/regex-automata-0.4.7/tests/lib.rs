...
fn untestify_kind(kind: regex_test::MatchKind) -> Option<regex_automata::MatchKind> {
    match kind {
        regex_test::MatchKind::All => Some(regex_automata::MatchKind::All),
        regex_test::MatchKind::LeftmostFirst => Some(regex_automata::MatchKind::LeftmostFirst),
