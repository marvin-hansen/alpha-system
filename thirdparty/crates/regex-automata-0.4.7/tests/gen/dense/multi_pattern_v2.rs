...
pub static MULTI_PATTERN_V2: Lazy<Regex<DFA<&'static [u32]>>> = Lazy::new(|| {
    let dfafwd = {
        static ALIGNED: &AlignAs<[u8], u32> = &AlignAs {
            ...
            bytes: *include_bytes!("multi_pattern_v2_fwd.littleendian.dfa"),
        };
    ...
    let dfarev = {
        static ALIGNED: &AlignAs<[u8], u32> = &AlignAs {
            ...
            #[cfg(target_endian = "little")]
            bytes: *include_bytes!("multi_pattern_v2_rev.littleendian.dfa"),
        };
        DFA::from_bytes(&ALIGNED.bytes)
