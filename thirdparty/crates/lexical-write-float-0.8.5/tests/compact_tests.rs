...
fn check_normalize(mant: u64, exp: i32, ymant: u64, yexp: i32) {
    let mut x = ExtendedFloat80 { mant, exp };
    if x.mant != 0 {
...
fn from_f32_test() {
    assert_eq!(
        ...
        ExtendedFloat80 { mant: 0, exp: -149 }
    );
    assert_eq!(
        compact::from_float(-0.0f32),
        ExtendedFloat80 { mant: 0, exp: -149 }
    ...
    assert_eq!(
        ...
        ExtendedFloat80 { mant: 1, exp: -149 }
    );
    assert_eq!(
...
fn write_float_scientific_test() {
    ...
    write_float_scientific(
        mut_b!(b"17976931348623157"),
        308,
        &options,
        "1.7976931348623157e308",
    );
    write_float_scientific(
        mut_b!(b"22250738585072014"),
        -308,
        &options,
        "2.2250738585072014e-308",
    );
