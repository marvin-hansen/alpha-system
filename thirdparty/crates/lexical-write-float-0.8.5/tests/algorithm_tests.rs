...
fn to_decimal_test() {
    ...
    assert_eq!(
        to_decimal_f64(2.2250738585072014e-308),
        (22250738585072014, -324)
    );
    assert_eq!(
        to_decimal_f64(1.7976931348623157e+308),
...
fn compute_nearest_normal_test() {
    ...
    assert_eq!(
        compute_nearest_normal(13.9999999999999982236431606),
        (13999999999999998, -15)
    );
}
...
fn compute_left_closed_directed_test() {
    assert_eq!(
        compute_left_closed_directed(1.23456),
        (12345600000000002, -16)
    );
    assert_eq!(
...
fn write_float_scientific(mant: u64, exp: i32, options: &Options, expected: &str) {
    ...
    let fp = ExtendedFloat80 { mant, exp };
...
fn write_float_scientific_test() {
    ...
    write_float_scientific(
        ...
        0,
        &options,
        "1.0000000000000000000000000000000000000000000000000e0",
    );
    write_float_scientific(
        1,
        3,
        &options,
        "1.0000000000000000000000000000000000000000000000000e3",
    );
    write_float_scientific(
        1,
        -12,
