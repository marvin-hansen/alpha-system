...
use super::{
    utils::{Array, TypeName},
    Field, FIELDS,
};
use crate::{array::BitArray, index::BitIdx, mem::bits_of, order::BitOrder, store::BitStore};
    ...
    T::Mem: Serialize,
{
        ...
        S: Serializer,
    {
        ...
        state.serialize_field("data", Array::from_ref(core::array::from_ref(&self.data)))?;
    ...
    T::Mem: Deserialize<'de>,
{
    ...
    where
        D: Deserializer<'de>,
    {
        deserializer.deserialize_struct("BitArr", FIELDS, BitArrVisitor::<T, O, N>::THIS)
    }
}
