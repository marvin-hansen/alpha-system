...
use crate::{
    domain::Domain, field::BitField, mem::bits_of, order::Msb0, slice::BitSlice, store::BitStore,
};
    ...
    T: BitStore,
{
    ...
    pub(crate) unsafe fn sp_copy_within_unchecked(
        ...
        let to = this
            .get_unchecked(dest)
            .chunks(WORD_BITS)
            .map(|bits| bits as *const BitSlice<T::Access, Msb0> as *mut BitSlice<T::Access, Msb0>);
    ...
    pub(crate) fn sp_first_one(&self) -> Option<usize> {
        ...
        match self.domain() {
            Domain::Enclave(elem) => {
                ...
                accum += val.leading_zeros() as usize - elem.head().into_inner() as usize;
    ...
    pub(crate) fn sp_first_zero(&self) -> Option<usize> {
        ...
        match self.domain() {
            Domain::Enclave(elem) => {
                ...
                accum += val.leading_ones() as usize - elem.head().into_inner() as usize;
