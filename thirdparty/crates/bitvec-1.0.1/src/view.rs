...
use crate::{
    array::BitArray, order::BitOrder, ptr::BitSpanError, slice::BitSlice, store::BitStore,
};
...
pub trait BitView {
    ...
    fn try_view_bits<O>(&self) -> Result<&BitSlice<Self::Store, O>, BitSpanError<Self::Store>>
    where
        O: BitOrder;
