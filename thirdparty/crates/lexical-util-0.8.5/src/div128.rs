...
fn u128_divrem_5(n: u128) -> (u128, u64) {
    moderate_u128_divrem(
        n,
        7450580596923828125,
        105312291668557186697918027683670432319,
        61,
    )
}
...
fn u128_divrem_7(n: u128) -> (u128, u64) {
    moderate_u128_divrem(
        n,
        3909821048582988049,
        200683792729517998822275406364627986707,
        61,
    )
}
...
fn u128_divrem_13(n: u128) -> (u128, u64) {
    moderate_u128_divrem(
        n,
        8650415919381337933,
        181410402513790565292660635782582404765,
        62,
    )
}
...
fn u128_divrem_15(n: u128) -> (u128, u64) {
    moderate_u128_divrem(
        n,
        6568408355712890625,
        1866504587258795246613513364166764993,
        55,
    )
}
...
fn u128_divrem_17(n: u128) -> (u128, u64) {
    moderate_u128_divrem(
        n,
        2862423051509815793,
        68529153692836345537218837732158950089,
        59,
    )
}
...
fn u128_divrem_19(n: u128) -> (u128, u64) {
    moderate_u128_divrem(
        ...
        25842538415601616733690423925257626679,
        60,
    )
}
...
fn u128_divrem_21(n: u128) -> (u128, u64) {
    moderate_u128_divrem(
        n,
        3243919932521508681,
        120939747781233590383781714337497669585,
        60,
    )
}
...
fn u128_divrem_23(n: u128) -> (u128, u64) {
    moderate_u128_divrem(
        ...
        270731922700393644432243678371210997949,
        63,
    )
}
...
fn u128_divrem_25(n: u128) -> (u128, u64) {
    moderate_u128_divrem(
        n,
        1490116119384765625,
        131640364585696483372397534604588040399,
        59,
    )
}
...
fn u128_divrem_29(n: u128) -> (u128, u64) {
    moderate_u128_divrem(
        ...
        152941450056053853841698190746050519297,
        62,
    )
}
...
fn u128_divrem_31(n: u128) -> (u128, u64) {
    moderate_u128_divrem(
        n,
        787662783788549761,
        124519929891402176328714857711808162537,
        58,
    )
}
...
fn u128_divrem_35(n: u128) -> (u128, u64) {
    moderate_u128_divrem(
        n,
        3379220508056640625,
        116097442450503652080238494022501325491,
        60,
    )
}
