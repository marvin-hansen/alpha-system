...
fn u64_decimal_test() {
    ...
    assert_eq!(
        ...
        u64::from_lexical(b"9223372036854775807")
    );
    assert_eq!(
        Ok(9223372036854775808),
        u64::from_lexical(b"9223372036854775808")
    );
    assert_eq!(
        Ok(18446744073709551615),
        u64::from_lexical(b"18446744073709551615")
    );
...
fn i64_decimal_test() {
    ...
    assert_eq!(
        Ok(9223372036854775807),
        i64::from_lexical(b"9223372036854775807")
    );
    assert_eq!(
        Err(Error::Overflow(18)),
    ...
    assert!(
        i64::from_lexical(b"406260572150672006000066000000060060007667760000000000000000000")
            .err()
            .unwrap()
            .is_overflow()
    );
...
fn options_test() {
    ...
    assert_eq!(
        Ok(0),
        i128::from_lexical_with_options::<STANDARD>(b"0", &options)
    );
}
...
fn i32_binary_test() {
    ...
    assert_eq!(
        i32::from_lexical_with_options::<FORMAT>(b"11", &options),
        Ok(3)
    );
    assert_eq!(
        i32::from_lexical_with_options::<FORMAT>(b"-11", &options),
