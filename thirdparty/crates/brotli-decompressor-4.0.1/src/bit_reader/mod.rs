...
mod tests {
  ...
  fn warmup_works() {
    let data: [u8; 37] = [
      ...
      0x21, 0xfd, 0xff, 0x87, 0x03, 0x6c, 0x63, 0x90, 0xde, 0xe9, 0x36, 0x04, 0xf8, 0x89, 0xb4,
      0x4d, 0x57, 0x96, 0x51, 0x0a, 0x54, 0xb7, 0x54, 0xee, 0xf4, 0xdc, 0xa0, 0x05, 0x9b, 0xd2,
      0x2b, 0x30, 0x8f,
    ]; // 33 b goods
  ...
  fn bit_read_tests() {
    {
      let data: [u8; 32] = [
        0xba, 0xaa, 0xad, 0xdd, 0x57, 0x5c, 0xd9, 0xa3, 0x3e, 0xb3, 0x77, 0xe7, 0xa0, 0x1e, 0x09,
        0xd3, 0x12, 0xa1, 0x3f, 0xb8, 0x7e, 0x5a, 0x06, 0x86, 0xe5, 0x36, 0xef, 0x9c, 0x9f, 0x6d,
        0x9b, 0xcc,
      ];
      let mut bit_reader = BrotliBitReader {
    ...
    {
      let data: [u8; 28] = [
        0xba, 0xaa, 0xaa, 0xad, 0x74, 0x40, 0x8e, 0xee, 0xd2, 0x38, 0xf1, 0xf4, 0xf8, 0x1d, 0x9f,
        0x24, 0x48, 0x1e, 0x82, 0xce, 0x48, 0x88, 0xd7, 0x25, 0x74, 0xaf, 0xe3, 0xea,
      ];
      let mut bit_reader = BrotliBitReader {
  ...
  fn const_fill_bit_window_tests() {
    {
      let data: [u8; 36] = [
        0xff, 0x9a, 0xa0, 0xde, 0x50, 0x99, 0x67, 0x67, 0x69, 0x87, 0x0e, 0x69, 0xeb, 0x6a, 0xd1,
        0x56, 0xc0, 0x32, 0x96, 0xed, 0x78, 0x0e, 0x19, 0xdd, 0x0b, 0xe8, 0xf8, 0x33, 0x9f, 0xe0,
        0x69, 0x55, 0x59, 0x3f, 0x5d, 0xc8,
      ];
      let mut bit_reader = BrotliBitReader {
    ...
    {
      let data: [u8; 67] = [
        0xf0, 0x0d, 0x7e, 0x18, 0x70, 0x1c, 0x18, 0x57, 0xbd, 0x73, 0x47, 0xc1, 0xb4, 0xf7, 0xe2,
        0xbe, 0x17, 0x6e, 0x26, 0x01, 0xb2, 0xd5, 0x55, 0xd8, 0x68, 0x1b, 0xc2, 0x87, 0xb4, 0xb1,
        0xd9, 0x42, 0xac, 0x0d, 0x67, 0xb1, 0x93, 0x54, 0x49, 0xa4, 0x69, 0xf8, 0x16, 0x0e, 0x61,
        0xb3, 0xdb, 0x98, 0xbb, 0xeb, 0xfa, 0xcb, 0x14, 0xcd, 0x68, 0x77, 0xa1, 0x33, 0x6c, 0x49,
        0xfa, 0x35, 0xbb, 0xeb, 0xee, 0x7b, 0xae,
      ];
      let mut bit_reader = BrotliBitReader {
