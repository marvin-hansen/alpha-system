...
#[macro_use]
mod poll;
pub use poll::{Async, AsyncSink, Poll, StartSend};
...
#[deprecated(since = "0.1.4", note = "import through the future module instead")]
pub use future::{
    AndThen, Done, Empty, Failed, Finished, Flatten, FlattenStream, Fuse, IntoStream, Join, Join3,
    Join4, Join5, Lazy, Map, MapErr, OrElse, Select, SelectNext, Then,
};
