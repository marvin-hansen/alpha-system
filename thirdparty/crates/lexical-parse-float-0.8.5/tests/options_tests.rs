...
fn invalid_nan_test() {
    let mut builder = OptionsBuilder::default();
    builder = builder.nan_string(Some(
        b"naaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaan",
    ));
    assert!(!builder.is_valid());
...
fn invalid_inf_test() {
    let mut builder = OptionsBuilder::default();
    builder = builder.inf_string(Some(
        b"innnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnf",
    ));
    assert!(!builder.is_valid());
...
fn invalid_infinity_test() {
    let mut builder = OptionsBuilder::default();
    builder = builder.infinity_string(Some(
        b"innnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnf",
    ));
    assert!(!builder.is_valid());
...
fn builder_test() {
    ...
    assert_eq!(
        builder.get_infinity_string(),
        Some("Infiniiiiiity".as_bytes())
    );
