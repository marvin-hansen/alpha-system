...
fn compute_float_f32_test() {
    ...
    assert_eq!(
        compute_float32(0, 16777217),
        (111 + INVALID_FP, 9223372586610589696)
    );
    assert_eq!(compute_float32(0, 16777218), (151, 1));
    assert_eq!(
        compute_float32(0, 16777219),
...
fn compute_float_f64_test() {
    ...
    assert_eq!(
        compute_float64(0, 9007199254740993),
        (1065 + INVALID_FP, 9223372036854776832)
    );
    assert_eq!(compute_float64(0, 9007199254740994), (1076, 1));
    assert_eq!(
        compute_float64(0, 9007199254740995),
    ...
    assert_eq!(
        ...
        (1065 + INVALID_FP, 9223372036854778879)
    );
