...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            ...
            "hickory-resolver": Label("//thirdparty/crates/hickory-resolver-0.24.3:hickory_resolver"),
            "iggy": Label("//thirdparty/crates/iggy-0.6.200:iggy"),
            ...
            "rustls": Label("//thirdparty/crates/rustls-0.23.23:rustls"),
            ...
            "syn": Label("//thirdparty/crates/syn-2.0.98:syn"),
...
_PROC_MACRO_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "async-trait": Label("//thirdparty/crates/async-trait-0.1.86:async_trait"),
