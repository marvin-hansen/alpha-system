...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            ...
            "blake3": Label("//thirdparty/crates/blake3-1.8.1:blake3"),
            "bon": Label("//thirdparty/crates/bon-3.5.2:bon"),
            "bytes": Label("//thirdparty/crates/bytes-1.10.1:bytes"),
            "chrono": Label("//thirdparty/crates/chrono-0.4.40:chrono"),
            "crossbeam": Label("//thirdparty/crates/crossbeam-0.8.4:crossbeam"),
            "diesel": Label("//thirdparty/crates/diesel-2.2.9:diesel"),
            ...
            "hickory-resolver": Label("//thirdparty/crates/hickory-resolver-0.25.1:hickory_resolver"),
            "lru": Label("//thirdparty/crates/lru-0.12.5:lru"),
            "memmap2": Label("//thirdparty/crates/memmap2-0.9.5:memmap2"),
            "mimalloc": Label("//thirdparty/crates/mimalloc-0.1.46:mimalloc"),
            "pq-sys": Label("//thirdparty/crates/pq-sys-0.6.3:pq_sys"),
            "prost": Label("//thirdparty/crates/prost-0.13.5:prost"),
            "prost-types": Label("//thirdparty/crates/prost-types-0.13.5:prost_types"),
            ...
            "quote": Label("//thirdparty/crates/quote-1.0.40:quote"),
            "reqwest": Label("//thirdparty/crates/reqwest-0.12.15:reqwest"),
            "rkyv": Label("//thirdparty/crates/rkyv-0.8.10:rkyv"),
            "rust_decimal": Label("//thirdparty/crates/rust_decimal-1.37.1:rust_decimal"),
            "rustls": Label("//thirdparty/crates/rustls-0.23.25:rustls"),
            "serde": Label("//thirdparty/crates/serde-1.0.219:serde"),
            "serde_json": Label("//thirdparty/crates/serde_json-1.0.140:serde_json"),
            "service_utils": Label("//thirdparty/crates/service_utils-0.2.0:service_utils"),
            "sha3": Label("//thirdparty/crates/sha3-0.11.0-pre.5:sha3"),
            "syn": Label("//thirdparty/crates/syn-2.0.100:syn"),
            "tempfile": Label("//thirdparty/crates/tempfile-3.19.1:tempfile"),
            "tokio": Label("//thirdparty/crates/tokio-1.44.2:tokio"),
...
_PROC_MACRO_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "async-trait": Label("//thirdparty/crates/async-trait-0.1.88:async_trait"),
            "enum_dispatch": Label("//thirdparty/crates/enum_dispatch-0.3.13:enum_dispatch"),
            "rust_decimal_macros": Label("//thirdparty/crates/rust_decimal_macros-1.37.1:rust_decimal_macros"),
...
_CONDITIONS = {
    ...
    "cfg(not(all(target_family = \"wasm\", target_os = \"unknown\")))": ["@rules_rust//rust/platform:aarch64-apple-darwin", "@rules_rust//rust/platform:aarch64-apple-ios", "@rules_rust//rust/platform:aarch64-apple-ios-sim", "@rules_rust//rust/platform:aarch64-linux-android", "@rules_rust//rust/platform:aarch64-pc-windows-msvc", "@rules_rust//rust/platform:aarch64-unknown-fuchsia", "@rules_rust//rust/platform:aarch64-unknown-linux-gnu", "@rules_rust//rust/platform:aarch64-unknown-nixos-gnu", "@rules_rust//rust/platform:aarch64-unknown-nto-qnx710", "@rules_rust//rust/platform:aarch64-unknown-uefi", "@rules_rust//rust/platform:arm-unknown-linux-gnueabi", "@rules_rust//rust/platform:armv7-linux-androideabi", "@rules_rust//rust/platform:armv7-unknown-linux-gnueabi", "@rules_rust//rust/platform:i686-apple-darwin", "@rules_rust//rust/platform:i686-linux-android", "@rules_rust//rust/platform:i686-pc-windows-msvc", "@rules_rust//rust/platform:i686-unknown-freebsd", "@rules_rust//rust/platform:i686-unknown-linux-gnu", "@rules_rust//rust/platform:powerpc-unknown-linux-gnu", "@rules_rust//rust/platform:riscv32imc-unknown-none-elf", "@rules_rust//rust/platform:riscv64gc-unknown-none-elf", "@rules_rust//rust/platform:s390x-unknown-linux-gnu", "@rules_rust//rust/platform:thumbv7em-none-eabi", "@rules_rust//rust/platform:thumbv8m.main-none-eabi", "@rules_rust//rust/platform:wasm32-wasip1", "@rules_rust//rust/platform:x86_64-apple-darwin", "@rules_rust//rust/platform:x86_64-apple-ios", "@rules_rust//rust/platform:x86_64-linux-android", "@rules_rust//rust/platform:x86_64-pc-windows-msvc", "@rules_rust//rust/platform:x86_64-unknown-freebsd", "@rules_rust//rust/platform:x86_64-unknown-fuchsia", "@rules_rust//rust/platform:x86_64-unknown-linux-gnu", "@rules_rust//rust/platform:x86_64-unknown-nixos-gnu", "@rules_rust//rust/platform:x86_64-unknown-none", "@rules_rust//rust/platform:x86_64-unknown-uefi"],
