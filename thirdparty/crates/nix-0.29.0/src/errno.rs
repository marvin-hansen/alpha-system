...
impl Errno {
    ...
    #[deprecated(since = "0.28.0", note = "please use `Errno::from_raw()` instead")]
...
fn desc(errno: Errno) -> &'static str {
    ...
    match errno {
        ...
        #[cfg(any(linux_android, solarish, target_os = "aix", target_os = "fuchsia"))]
        ...
        #[cfg(any(linux_android, target_os = "fuchsia", target_os = "openbsd"))]
        EMEDIUMTYPE => "Wrong medium type",

        #[cfg(any(linux_android, solarish, target_os = "fuchsia", target_os = "haiku"))]
        ...
        #[cfg(any(freebsdlike, apple_targets, target_os = "openbsd", target_os = "hurd"))]
        ENOTRECOVERABLE => "State not recoverable",
