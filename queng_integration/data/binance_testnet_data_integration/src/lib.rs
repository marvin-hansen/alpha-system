...
const API_BASE_URL: &str = "https://testnet.binance.vision/api/v3";
const API_WSS_URL: &str = "wss://testnet.binance.vision/ws";

pub struct ImsBinanceTestnetDataIntegration {
    integration: ImsBinanceDataIntegration,
}

impl ImsBinanceTestnetDataIntegration {
    pub fn new() -> Self {
        Self {
...
impl Default for ImsBinanceTestnetDataIntegration {
    fn default() -> Self {
        Self::new()
    }
}

impl ImsDataIntegration for ImsBinanceTestnetDataIntegration {
...
impl ImsTradeDataIntegration for ImsBinanceTestnetDataIntegration {
...
impl ImsOhlcvDataIntegration for ImsBinanceTestnetDataIntegration {
