...
pub(crate) fn get_test_meta_instrument(base_asset: String, quote_asset: String) -> MetaInstrument {
    ...
    MetaInstrument {
        ...
        exchange_code: utils_import::get_partial_import_test_exchange_id(),
