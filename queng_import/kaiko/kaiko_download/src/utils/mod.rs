...
impl DownloadUtils {
    pub fn new(url: &str) -> Self {
        Self {
            ...
            url_assets: Self::format_url(url, "assets"),
            url_exchanges: Self::format_url(url, "exchanges"),
            url_instruments: Self::format_url(url, "instruments"),
            url_stats: Self::format_url(url, "stats"),
        }
    }
}
