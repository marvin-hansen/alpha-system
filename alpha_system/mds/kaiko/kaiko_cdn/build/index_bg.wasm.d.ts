...
export function fetch(a: number, b: number, c: number): number;
...
export function __wbg_minifyconfig_free(a: number, b: number): void;
...
export function __wbg_r2range_free(a: number, b: number): void;
