...
impl DBGatewayClient {
    pub async fn create_service(&self, data: ServiceConfig) -> Result<bool, DBGatewayError> {
        ...
        let proto_service_config = data.to_proto().expect("Failed to convert Rust PortfolioConfig to proto");
    ...
    pub async fn check_if_service_id_exists(&self, id: ServiceID) -> Result<bool, DBGatewayError> {
        ...
        let request = tonic::Request::new(SingleServiceRequest { service_id: id as i32 });
    ...
    pub async fn check_if_services_exists(
        ...
        let services_id = services.iter().map(|s| s.to_owned() as i32).collect::<Vec<i32>>();
        ...
        match res {
            Ok(res) => {
                ...
                let vec = res
                    ...
                    .service_configs
                    .iter()
                    .map(|s| ServiceConfig::from_proto(s.to_owned())
    ...
    pub async fn read_service_by_id(&self, id: ServiceID) -> Result<Option<ServiceConfig>, DBGatewayError> {
