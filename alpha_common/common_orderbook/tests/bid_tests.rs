...
fn test_new() {
    ...
    let ask_bid = Bid::new(price, quantity);
...
fn test_eq() {
    let price = Decimal::new(105, 1);
    let quantity = Decimal::new(20, 1);
    let ask_bid1 = Bid::new(price, quantity);
    let ask_bid2 = Bid::new(price, quantity);
...
fn test_neq_price() {
    ...
    let quantity = Decimal::new(20, 1);
    let ask_bid1 = Bid::new(price1, quantity);
    let ask_bid2 = Bid::new(price2, quantity);
...
fn test_neq_quantity() {
    ...
    let ask_bid1 = Bid::new(price, quantity1);
    let ask_bid2 = Bid::new(price, quantity2);
    assert_ne!(ask_bid1, ask_bid2);
}
