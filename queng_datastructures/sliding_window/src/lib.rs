...
// Re exports
pub use crate::storage::WindowStorage;
...
///
/// ```
/// use sliding_window::{VectorStorage, SlidingWindow};
///
...
/// }
///
/// let mut window: SlidingWindow<VectorStorage<Data>, Data>=sliding_window::new_with_vector_storage(SIZE, MULT);
///
/// assert!(window.empty());
...
/// Creates a new [`SlidingWindow`] with an array-based storage implementation.
