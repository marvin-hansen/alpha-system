...
# "---------------------------------------------------------"
# "-                                                       -"
# "-  Create or updates build containers and pushes to gcr -"
# "-                                                       -"
# "---------------------------------------------------------"
...
command kubectl create secret generic dns-access --from-literal=DNS_SERVER="$DNS" --namespace=quant-engine
