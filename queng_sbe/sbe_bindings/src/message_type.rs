...
pub enum MessageType {
    ...
    DataBar = 0xcc_u16,
    TradeBar = 0xcf_u16,
    OrderSingleNew = 0x191_u16,
    OrderSingleUpdate = 0x192_u16,
    OrderCancelSingle = 0x193_u16,
...
impl From<u16> for MessageType {
    ...
    fn from(v: u16) -> Self {
        match v {
            ...
            0x191_u16 => Self::OrderSingleNew,
            0x192_u16 => Self::OrderSingleUpdate,
            0x193_u16 => Self::OrderCancelSingle,
